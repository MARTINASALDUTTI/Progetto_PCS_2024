...
*/
    ...
    new_points.row(0) << 0.4272, 0.352669, 0.329511;
    new_points.row(1) << 0.507259, 0.626342, 0.606678;
    new_points.row(2) << 0.597042, 0.530771, 0.597042;
*/

    Eigen::MatrixXd new_points(3, 4);


    new_points.row(0) << 0.492678, 0.364069, 0.352669,   0.4272;
    new_points.row(0) << 0.440621, 0.636022, 0.626342, 0.507259;
    new_points.row(0) << 0.597042, 0.498147, 0.530771, 0.597042;
